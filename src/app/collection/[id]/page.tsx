...
/* ============================================================
   ...
   ------------------------------------------------------------
   POUR DÉPLACER UNE PHOTO : change juste son id de section
   dans SECTIONS ci-dessous. Toute œuvre non listée tombe
   automatiquement dans une section "More" (aucune ne disparaît).
   ============================================================ */
