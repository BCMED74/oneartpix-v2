/* ============================================================
   API — /api/contact
   Envoie l'e-mail via le SMTP Infomaniak authentifié.
   Mot de passe stocké en Base64 (SMTP_PASS_B64) dans .env.local.
...
/* === Décode le mot de passe Base64 (repli sur clair si besoin) === */
...
/* === Champs affichés en priorité dans l'e-mail === */
...
export async function POST(req: Request) {
  try {
    ...
    /* === 4. ENVOI === from authentifié · replyTo = visiteur === */
