...
/* ============================================================
   NAVIGATION — logo GRAND FORMAT centré (signature qui déborde)
   ============================================================ */
    ...
    >
      <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
        ...
        >
          ...
          {/* CENTRE — logo XXL (déborde vers le bas) */}
          <Link href="/" onClick={() => setOpen(false)} aria-label="OneArtPix — home"
            style={{ justifySelf: "center", display: "block", marginBottom: "-22px" }}>
            <img src="/oneartpix-logo-gold.png" alt="OneArtPix"
              style={{ height: "clamp(66px, 7vw, 104px)", width: "auto", display: "block" }} />
          </Link>
